  ...
  return (
    <>
      <div className="min-h-screen flex flex-col">
        <div className="bg-gradient-to-l from-indigo-400 to-violet-400 min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="bg-stone-800 text-white text-center py-4 mt-auto">
         © 2025 Currency Convertor | Ruchi Pawar
      </div>
      </div>
    </>
  );
